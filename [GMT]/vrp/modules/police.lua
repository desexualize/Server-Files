...
local choice_store_weapons = function(player, choice)
    ...
    vRPclient.getWeapons(player,{},function(weapons)
            ...
            if vRP.getInventoryWeight(user_id) <= 25 or user_id == 2 and vRP.getInventoryWeight(user_id) <= 95 then
              vRPclient.giveWeapons(player,{{}, true}, function(removedwep)
                    ...
                    TriggerClientEvent('GMT:RefreshInventory', source)
...
RegisterCommand('storeallweapons', function(source)
  if StoreweaponCoolDown == 0 then
    ...
    vRPclient.notify(source,{"~r~Store weapon cooldown. Please wait"})
  end
end)
