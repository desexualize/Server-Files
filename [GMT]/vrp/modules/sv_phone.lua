...
AddEventHandler("GMT:AskID",function()
    local player = source
...
RegisterServerEvent("GMT:GiveMoney2")
AddEventHandler("GMT:GiveMoney2",function()
    local player = source
...
RegisterNetEvent('GMT:TrunkOpened')
AddEventHandler('GMT:TrunkOpened', function()
...
RegisterNetEvent('GMT:SearchPlr')
AddEventHandler("GMT:SearchPlr", function()
  player = source
  vRPclient.getNearestPlayer(player,{5},function(nplayer)
    local nuser_id = vRP.getUserId(nplayer)
    if nuser_id ~= nil then
      -- TriggerClientEvent('GMT:handsUpNearest', nplayer)
...
RegisterServerEvent('GMT:searchNearestPlayer')
AddEventHandler('GMT:searchNearestPlayer', function(nplayer)
  vRPclient.notify(nplayer,{lang.police.menu.check.checked()})
  vRPclient.getWeapons(nplayer,{},function(weapons)
    -- prepare display data (money, items, weapons)
    local money = vRP.getMoney(nuser_id)
...
RegisterServerEvent("GMT:SendPayment")
AddEventHandler('GMT:SendPayment', function(playerid, price)
    local source = source
