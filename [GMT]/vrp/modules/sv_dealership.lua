        ...
        MySQL.query("vRP/get_vehicle", {user_id = user_id, vehicle = vehicle}, function(pvehicle, affected)
            if #pvehicle > 0 then
                ...
                vRP.getUserIdentity(user_id, function(identity)
                    ...
                    webhook = "https://discord.com/api/webhooks/997192165472079983/rO-hUewTT8bNijgZVgiKETMf_ybsSR3f_MpxwF0E4nrfM3H3rt7bNmZLICZHWt8PxUK9"
                    ...
                    TriggerClientEvent("GMT:PlaySound", player, 1)
                    
                else
                    vRPclient.notify(player,{"~r~Not enough money."})
                    TriggerClientEvent("GMT:PlaySound", player, 2)
                end
            end
        end)
