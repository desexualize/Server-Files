...
-- -- vehicle db
local lang = vRP.lang
local cfg = module("GMTCars", "cfg/cfg_garages")
local cfg_inventory = module("GMTCars", "cfg/cfg_inventory")
...
Citizen.CreateThread(function()
    while true do
        ...
        print('[GMT] Vehicle Rent Check | Successful')
    end
end)
                                                    ...
                                                    vRP.request(target,GetPlayerName(player).." wants to sell: " ..name.. " Price: £"..amount, 10, function(target,ok)
                                                        if ok then
                                                            ...
                                                            if vRP.tryFullPayment(pID,amount) then
                                                                ...
                                                                webhook = "https://discord.com/api/webhooks/997199870819582033/sAgdk6_uK3bICuQHrdyYbMs9rwNqNcLxvtY7UXaqyLB619AnWE4l4bNxf3kuT1uuEJMN"
