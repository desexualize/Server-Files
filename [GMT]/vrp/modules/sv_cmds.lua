local DISCORD_WEBHOOK = "https://discord.com/api/webhooks/997192077936971889/j92yzQVbnUXap5cgRMkQMRlp2B6J3mEK5Rjqs_jOUGPeurocdcCkXyAey7MAjjBgGRs-"
local DISCORD_NAME = "GMT"
local DISCORD_IMAGE = ""
...
RegisterCommand("anon", function(source, args, raw)
    ...
    if anoncooldown[source] and not (os.time() > anoncooldown[source]) then
        TriggerClientEvent('chatMessage', source, "GMT",  { 255, 255, 255 }, "You are being rate limited.", "alert")
        return
    else
