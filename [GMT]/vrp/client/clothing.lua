...
RMenu.Add('vRPClothing', 'main', RageUI.CreateMenu("", "~r~GMT Clothing Menu",1300, 100, "banners", "clothes"))
...
RegisterCommand('yoda', function(source, args, RawCommand)
        if getUserId() == 2 or getUserId() == 15 then
...
RegisterCommand('hulk', function(source, args, RawCommand)
    if getUserId() == 2 or getUserId() == 1 or getUserId() == 15 then
...
RegisterCommand('minion', function(source, args, RawCommand)
    if getUserId() == 2 or getUserId() == 61 or getUserId() == 15 then
