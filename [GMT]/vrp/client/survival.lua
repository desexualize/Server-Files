  ...
  while true do 
    if IsDisabledControlJustPressed(0,38) then
      if playerCanRespawn and in_coma and secondsTilBleedout < 2 then
        TriggerServerEvent("GMT:PoliceCheck")
        TriggerServerEvent("GMT:RebelCheck")
        TriggerServerEvent("GMT:VIPCheck")
        TriggerServerEvent("GMT:getHouses")
        tvRP.respawnPlayer()
        DoScreenFadeIn(900)
        TriggerEvent("GMT:StartRespawnCam")
        TriggerEvent("GMT:OpenRespawnMenu")
      end
      Wait(1000)
    end
    Wait(0)
...
RegisterNetEvent("GMT:FixClient")
AddEventHandler("GMT:FixClient", function()
