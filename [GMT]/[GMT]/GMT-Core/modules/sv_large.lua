...
RegisterServerEvent("GMT:BuyGun")
AddEventHandler('GMT:BuyGun', function(hash)
    local source = source
...
RegisterServerEvent("GMT:BuyArmour")
AddEventHandler('GMT:BuyArmour', function(price, amount)
    local source = source
