...
local dropMsg = "A crate drop has been spotted at the Oil Rig..."
local removeMsg = "A Pirate has stole the loot..."
    ...
    if #(playerCoords - boxCoords) < 2.0 then
        if not used then
                ...
                if lootrandom == 1 then 
                    ...
                    vRP.giveInventoryItem({user_id, "wbody|" .. 'WEAPON_CHERRYMOSIN', 1, true})
