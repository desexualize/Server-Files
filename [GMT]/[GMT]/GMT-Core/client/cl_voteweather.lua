...
Citizen.CreateThread(function()
	while true do
		if voteInProgress then 
			...
			DrawAdvancedText(0.315, 0.848, 0.005, 0.0028, 0.318, "Halloween", 255, 255, 255, 255, 4, 0)
			...
			DrawAdvancedText(0.333, 0.848, 0.005, 0.0028, 0.25, tostring(votesTable["HALLOWEEN"]), 255, 74, 53, 255, 0, 0)
