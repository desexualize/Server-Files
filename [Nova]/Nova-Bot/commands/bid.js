...
exports.runcmd = (fivemexports, client, message, params) => {
    ...
    fivemexports.oxmysql.query("SELECT * FROM `vrp_user_ids` WHERE identifier = ?", ["discord:" + user.id], (result) => {
        if (result.length > 0) {
            fivemexports.oxmysql.query("SELECT * FROM vrp_user_moneys WHERE user_id = ?", [result[0].user_id], (result) => {
