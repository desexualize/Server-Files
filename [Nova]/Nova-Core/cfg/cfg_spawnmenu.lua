...
spawn.options = {
    ...
    {name = "Homerton Hospital", location = vector3(362.8176574707,-591.65472412109,28.673826217651)},
    ...
    {name = "Rebel Diner", location = vector3(1364.7171630859,6551.5874023438,14.376260757446)},
    {name = "You Tool", location = vector3(2752.7487792969,3470.6633300781,55.72989654541)},
