RMenu.Add("BronzeMenu", "main", RageUI.CreateMenu("", "~r~Large Arms Trader", 1300, 50, "large", "large"))
RMenu.Add("BronzeMenu", "confirm", RageUI.CreateSubMenu(RMenu:Get("BronzeMenu", "main", 1300, 50)))
RMenu.Add("BronzeMenu", "confirmA", RageUI.CreateSubMenu(RMenu:Get("BronzeMenu", "main", 1300, 50)))

currentTurf = 0
local isToggle = false
RageUI.CreateWhile(
    1.0,
    RMenu:Get("BronzeMenu", "main"),
    nil,
    function()
        RageUI.IsVisible(
            RMenu:Get("BronzeMenu", "main"),
            ...
            function()
                for i, p in pairs(bronze.guns) do
                    RageUI.Button(
                        p.name,
                        nil,
                        {RightLabel = "£" .. getMoneyStringFormatted(p.price + (p.price * (currentTurf / 100))) .. ""},
                        true,
        ...
        RageUI.IsVisible(
            ...
            function()
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            -- TriggerServerEvent('Nova:BuyArmour', isToogle)
...
Citizen.CreateThread(
    function()
        ...
        AddTextComponentSubstringPlayerName("Large Arms Dealer")
