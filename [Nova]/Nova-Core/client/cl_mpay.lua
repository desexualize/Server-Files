RMenu.Add("MPayMenu", "main", RageUI.CreateMenu("", "~w~MPay Menu", 1300, 50, "mpay", "mpay"))
RMenu.Add(
    "MPayMenu",
    "confirmation",
    RageUI.CreateSubMenu(RMenu:Get("MPayMenu", "main"), "", "~w~MPay Confirmation Menu", nil, nil)
)
...
RageUI.CreateWhile(
    ...
    function()
        RageUI.IsVisible(
            ...
            function()
                RageUI.Button(
                    "Transaction Amount - ~y~[ £" .. finalMPayAmount .. " ]",
                    nil,
                    {RightLabel = "→→→"},
                    true,
                ...
                RageUI.Button(
                    "Receivers perm ID - ~y~[ " .. finalPlayerID .. " ]",
                    nil,
                    {RightLabel = "→→→"},
                    true,
                    function(Hovered, Active, Selected)
                ...
                if enteredID == true and enteredMoney == true then
                    RageUI.Button(
                        "~g~[Confirm MPay Transaction]",
                        "~g~Receivers ID: ~w~" .. playerID .. ", ~g~Transaction Amount: ~w~£" .. MPayAmount,
                        {RightLabel = "→→→"},
                        true,
                        function(Hovered, Active, Selected)
                            if Selected then
                        ...
                        RMenu:Get("MPayMenu", "confirmation")
                    )
                end
            end
        )
        ...
        RageUI.IsVisible(
            ...
            function()
                RageUI.Button(
                    "~g~Yes, I confirm this Transaction!",
                    nil,
                    {RightLabel = "→→→"},
                    true,
                    function(Hovered, Active, Selected)
                        if Selected then
                            ...
                            TriggerServerEvent("Nova:SendPayment", finalPlayerID, finalMPayAmount)
                ...
                RageUI.Button(
                    "~r~No, I don't confirm this Transaction!",
                    nil,
                    {RightLabel = "→→→"},
                    true,
                    function(Hovered, Active, Selected)
