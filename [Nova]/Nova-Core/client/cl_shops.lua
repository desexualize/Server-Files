RMenu.Add("ShopMenu", "main", RageUI.CreateMenu("Shops", "Nova Shops", 1300, 50))
RMenu.Add("ShopMenu", "confirm", RageUI.CreateSubMenu(RMenu:Get("ShopMenu", "main", 1300, 50)))

local currentDrop = nil
RageUI.CreateWhile(
    1.0,
    RMenu:Get("ShopMenu", "main"),
    nil,
    function()
        RageUI.IsVisible(
            RMenu:Get("ShopMenu", "main"),
        ...
        RageUI.IsVisible(
            ...
            function()
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            TriggerServerEvent("Nova:ShopBuy2", 0, currentDrop)
                        end
                    end,
                    RMenu:Get("ShopMenu", "main")
                )
