RMenu.Add("LiveryMenu", "main", RageUI.CreateMenu("", "~w~Nova Livery Menu", 1300, 50, "livery", "livery"))

RMenu.Add(
    "LiveryMenu",
    "submain",
    RageUI.CreateSubMenu(RMenu:Get("LiveryMenu", "main"), "", "~w~Nova Livery Menu", 1300, 50, "livery", "livery")
)

RageUI.CreateWhile(
    1.0,
    RMenu:Get("LiveryMenu", "main"),
    nil,
    function()
        RageUI.IsVisible(
            RMenu:Get("LiveryMenu", "main"),
