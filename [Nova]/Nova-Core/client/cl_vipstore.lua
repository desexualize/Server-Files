...
RMenu.Add("VIPMenu", "main", RageUI.CreateMenu("", "~y~Nova VIP Store", 1300, 50, "vip", "vip"))

-- RageUI.CreateWhile(wait, menu, key, closure)
RageUI.CreateWhile(
    1.0,
    RMenu:Get("VIPMenu", "main"),
    nil,
    function()
            ...
            function()
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            getAmount()
                            TriggerServerEvent("Nova:Whitelist", gunid)
                        end
                    end
                )
            end,
...
Citizen.CreateThread(
    function(v1)
        ...
        AddTextComponentSubstringPlayerName("VIP Store")
