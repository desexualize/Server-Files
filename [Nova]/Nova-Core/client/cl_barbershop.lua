...
RMenu.Add(
    "barbershop",
    "main",
    RageUI.CreateMenu("Barber Shop", "~b~Barber Shop", nil, nil, "root_cause", "shopui_title_warstock")
)
RMenu.Add(
    "barbershop",
    "Hair",
    RageUI.CreateSubMenu(
        RMenu:Get("barbershop", "main"),
        "Hair",
        "~b~Hair",
        nil,
        nil,
        "root_cause",
        "shopui_title_warstock"
    )
)
RMenu.Add(
    "barbershop",
...
function skinBtn()
    RageUI.Button(
        ...
        RMenu:Get("barbershop", "SkinColour")
    )
end
...
function blemBtn()
    RageUI.Button(
        ...
        RMenu:Get("barbershop", "Blemishes")
    )
end
function finishBtn()
    RageUI.Button(
        ...
        function(Hovered, Active, Selected)
            if Selected then
                TriggerEvent("Nova:finishCut")
            end
        end,
        RMenu:Get("barbershop", "Finish")
    )
end
...
function compBtn()
    RageUI.Button(
        ...
        RMenu:Get("barbershop", "Complexion")
    )
end
...
function chesthairBtn()
    RageUI.Button(
        ...
        RMenu:Get("barbershop", "ChestHair")
    )
end
...
function hairSM()
    RageUI.IsVisible(
        ...
        true,
        function()
            for i = 0, GetNumberOfPedDrawableVariations(PlayerPedId(), 2) do
                RageUI.Button(
                    tostring(i),
                    nil,
                    {RightLabel = "→→→"},
                    ...
                    function(Hovered, Active, Selected)
                        if Active then
                            print(GetNumberOfPedTextureVariations(PlayerPedId(), 2, i))
                            SetPedComponentVariation(PlayerPedId(), 2, i, h, 0)
                            if continue == true then
                                if Selected then
                                    if GetNumberOfPedTextureVariations(PlayerPedId(), 2, i) - 2 < h then
                                        h = 0
                                        return
                                    end
                                    h = h + 1
                                    ...
                                    SetPedHairColor(PlayerPedId(), colour, colour)
                                    colour = colour + 1
            ...
            for i = 0, 255 do
                if i == 255 then
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                SetPedHeadOverlay(PlayerPedId(), 1, 34, 1.0)
                                SetPedHeadOverlayColor(PlayerPedId(), 1, 34, 2, 2)
                            end
                        end
                    )
                    return
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            --TriggerEvent('Nova:cutHair')
                            SetPedHeadOverlay(PlayerPedId(), 1, i, 1.0)
                            SetPedHeadOverlayColor(PlayerPedId(), 1, b, 2, 2)
                            if b == 28 then
                                b = 0
                                return
                            end
            ...
            for i = 0, 255 do
                if i == 255 then
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                SetPedHeadOverlay(PlayerPedId(), 8, 34, 1.0)
                                SetPedHeadOverlayColor(PlayerPedId(), 8, 34, 2, 2)
                            end
                        end
                    )
                    return
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            ----TriggerEvent('Nova:cutHair')
                            SetPedHeadOverlay(PlayerPedId(), 8, i, 1.0)
                            SetPedHeadOverlayColor(PlayerPedId(), 8, lc, 2, 2)
                            --SetPedHeadOverlayColor(PlayerPedId(), 8, 1, 2, 2)
                            if lc == 9 then
                                lc = 0
                                return
                            end
            ...
            for i = 0, 255 do
                if i == 255 then
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                SetPedHeadOverlay(PlayerPedId(), 2, 34, 1.0)
                                SetPedHeadOverlayColor(PlayerPedId(), 2, 34, 2, 2)
                            end
                        end
                    )
                    return
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            --TriggerEvent('Nova:cutHair')
                            SetPedHeadOverlay(PlayerPedId(), 2, i, 1.0)
                            SetPedHeadOverlayColor(PlayerPedId(), 2, ebc, 2, 2)
                            if ebc == 33 then
                                ebc = 0
                                return
                            end
            ...
            for i = 0, 255 do
                if i == 255 then
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                SetPedHeadOverlay(PlayerPedId(), 5, 33, 1.0)
                                SetPedHeadOverlayColor(PlayerPedId(), 5, 33, 2, 2)
                            end
                        end
                    )
                    return
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            --TriggerEvent('Nova:cutHair')
                            SetPedHeadOverlay(PlayerPedId(), 5, i, 1.0)
                            SetPedHeadOverlayColor(PlayerPedId(), 5, bc, 2, 2)
                            if bc == 6 then
                                bc = 0
                                return
                            end
            ...
            for i = 0, 255 do
                if i == 255 then
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                SetPedHeadOverlay(PlayerPedId(), 10, 33, 1.0)
                                SetPedHeadOverlayColor(PlayerPedId(), 10, 33, 2, 2)
                            end
                        end
                    )
                    return
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            --TriggerEvent('Nova:cutHair')
                            SetPedHeadOverlay(PlayerPedId(), 10, i, 1.0)
                            SetPedHeadOverlayColor(PlayerPedId(), 10, chc, 2, 2)
                            --SetPedHeadOverlayColor(PlayerPedId(), 8, 1, 2, 2)
                            if chc == 6 then
                                chc = 0
                                return
            ...
            for i = 0, 255 do
                if i == 255 then
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                SetPedHeadOverlay(PlayerPedId(), 3, 33, 1.0)
                                SetPedHeadOverlayColor(PlayerPedId(), 3, 33, 2, 2)
                            end
                        end
                    )
                    return
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            SetPedHeadOverlay(PlayerPedId(), 3, i, 1.0)
                            --TriggerEvent('Nova:cutHair')
                            SetPedHeadOverlayColor(PlayerPedId(), 3, agc, 2, 2)
                            if agc == 6 then
                                agc = 0
                                return
                            end
            ...
            for i = 0, 255 do
                if i == 255 then
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                SetPedHeadOverlay(PlayerPedId(), 6, 33, 1.0)
                                SetPedHeadOverlayColor(PlayerPedId(), 6, 33, 2, 2)
                            end
                        end
                    )
                    return
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            --TriggerEvent('Nova:cutHair')
                            SetPedHeadOverlay(PlayerPedId(), 6, i, 1.0)
                            SetPedHeadOverlayColor(PlayerPedId(), 6, comc, 2, 2)
                            --SetPedHeadOverlayColor(PlayerPedId(), 8, 1, 2, 2)
                            if comc == 6 then
                                comc = 0
                                return
            ...
            for i = 0, 255 do
                if i == 255 then
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                SetPedHeadOverlay(PlayerPedId(), 9, 33, 1.0)
                                SetPedHeadOverlayColor(PlayerPedId(), 9, 33, 2, 2)
                            end
                        end
                    )
                    return
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            --TriggerEvent('Nova:cutHair')
                            SetPedHeadOverlay(PlayerPedId(), 9, i, 1.0)
                            SetPedHeadOverlayColor(PlayerPedId(), 9, molesc, 2, 2)
                            if molesc == 6 then
                                molesc = 0
                                return
                            end
            ...
            for i = 0, 255 do
                if i == 255 then
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                SetPedHeadOverlay(PlayerPedId(), 0, 33, 1.0)
                                SetPedHeadOverlayColor(PlayerPedId(), 0, 33, 2, 2)
                            end
                        end
                    )
                    return
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            --TriggerEvent('Nova:cutHair')
                            SetPedHeadOverlay(PlayerPedId(), 0, i, 1.0)
                            SetPedHeadOverlayColor(PlayerPedId(), 0, belmc, 2, 2)
                            if belmc == 6 then
                                belmc = 0
                                return
                            end
        ...
        function()
            ...
            for i = 0, 255 do
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            SetPedHeadBlendData(PlayerPedId(), i, i, i, i, i, i, i, i, i, false)
                            if skinc == 6 then
                                skinc = 0
                                return
                            end
            ...
            for i = 0, 255 do
                if i == 255 then
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                SetPedHeadOverlay(PlayerPedId(), 4, 100, 1.0)
                                SetPedHeadOverlayColor(PlayerPedId(), 4, 100, 2, 2)
                            end
                        end
                    )
                    return
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            -- --TriggerEvent('Nova:cutHair')
                            SetPedHeadOverlay(PlayerPedId(), 4, i, 1.0)
                            SetPedHeadOverlayColor(PlayerPedId(), 4, makec, 2, 2)
                            if makec == 6 then
                                makec = 0
                                return
                            end
            ...
            for i = 0, 255 do
                if i == 255 then
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                SetPedHeadOverlay(PlayerPedId(), 11, 100, 1.0)
                                SetPedHeadOverlayColor(PlayerPedId(), 11, 100, 2, 2)
                            end
                        end
                    )
                    return
                ...
                RageUI.Button(
                    ...
                    function(Hovered, Active, Selected)
                        if Selected then
                            ...
                            SetPedHeadOverlay(PlayerPedId(), 11, i, 1.0)
                            -- print(i)
                            SetPedHeadOverlayColor(PlayerPedId(), 11, bblemc, 2, 2)
                            if bblemc == 6 then
                                bblemc = 0
                                return
                            end
            ...
            for k, brber in pairs(barbershops) do
                ...
                if barberIsInMenu == false then
                    if isInArea(v1, 1.4) then
                        ...
                        TriggerEvent(
                            "Nova:UINotify",
                            "~r~Make sure to change your skin colour first to ensure the rest of the features work."
                        )
                        RageUI.Visible(RMenu:Get("barbershop", "main"), true)
                        currentAmmunition = k
                        currentAmmunition = k
...
-- RegisterNetEvent('Nova:cutHair')
-- AddEventHandler('Nova:cutHair', function()
--     cuttingHair = true
...
-- RegisterNetEvent('Nova:finishCut')
-- AddEventHandler('Nova:finishCut', function()
--     finishCut = true
...
--     TriggerEvent('Nova:removeHairdresser')
--     destorycam()
--     destorycam2()
--     Citizen.Wait(4000)
--     DoScreenFadeIn(4000)
...
-- RegisterNetEvent('Nova:removeHairdresser')
-- AddEventHandler('Nova:removeHairdresser', function()
--     ClearPedTasksImmediately(HairDresser)
...
-- function gotoChair()
--     if Camera == true then
--         TaskGoToCoordAnyMeans(PlayerPedId(), -31.26,-153.71,56.576538085938, 0.5, 0, 0, 786603, 1.0)
--     end
-- end
