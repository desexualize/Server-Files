--RMenu.Add('CrateShop', 'main', RageUI.CreateMenu("Create Drop Shop", "Nova Crate Shop", 1300, 50))
--RMenu.Add("CrateShop", "confirm", RageUI.CreateSubMenu(RMenu:Get('CrateShop', 'main',  1300, 50)))
--
...
--            if Selected then
--                TriggerServerEvent('Nova:ShopBuy', 0, currentDrop)
--            end
...
--    AddTextComponentSubstringPlayerName("Crate Shop")
