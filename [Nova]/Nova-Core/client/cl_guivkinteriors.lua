...
function gui_interiors_drawMenuTitle(txt, x, y)
	...
	EndTextCommandDisplayText(x - menu.width / 2 + 0.005, y - menu.height / 2 + 0.0028)
end
...
function gui_interiors_drawMenuButton(button, x, y, selected)
	...
	SetTextCentre(0)
	BeginTextCommandDisplayText("STRING")
	AddTextComponentSubstringPlayerName(button.name)
	if selected then
...
function gui_interiors_drawMenuInfo(text)
	...
	EndTextCommandDisplayText(0.365, 0.934)
end
...
function gui_interiors_drawMenuRight(txt, x, y, selected)
	...
	EndTextCommandDisplayText(0.01 + (menu.width) + ((menu.width / 3) / 2), y - menu.height / 2 + 0.0028)
end
		...
		while true do
			...
			if POS_actual then
				...
				if gui_interiors.opened then
					...
					gui_interiors_drawTxt(
						gui_interiors.title,
						1,
						1,
						gui_interiors.menu.x,
						gui_interiors.menu.y,
						1.0,
						255,
						255,
						255,
					...
					gui_interiors_drawTxt(
						"~r~" .. gui_interiors.selectedbutton .. "/" .. tablelength(menu.buttons),
						0,
						0,
						gui_interiors.menu.x + gui_interiors.menu.width / 2 - 0.0385,
						gui_interiors.menu.y + 0.067,
						0.4,
						255,
						255,
						255,
