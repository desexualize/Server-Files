RMenu.Add("vRPClothing", "main", RageUI.CreateMenu("", "Nova Clothing Menu", 1350, 50, "clothes", "clothes"))
            ...
            RageUI.DrawContent(
                ...
                function()
                    RageUI.Button(
                        ...
                        RMenu:Get("vRPClothing", "clothingsubmenu")
                    )
                    RageUI.Button(
                        "Change Gender",
                        nil,
                        ...
                        RMenu:Get("vRPClothing", "changegendersubmenu")
                    )
                    RageUI.Button(
                        "Change Ped",
                        nil,
                        ...
                        RMenu:Get("vRPClothing", "changepedmenu")
                    )
                end
            )
        end
        ...
        if RageUI.Visible(RMenu:Get("vRPClothing", "clothingsubmenu")) then
            ...
            RageUI.DrawContent(
                ...
                function()
                    ...
                    AddTextComponentSubstringPlayerName("Press [SPACE] to input an ID")
                    ...
                    RageUI.List(
                        ...
                        Face.Index,
                        "Texture Index: " ..
                            Face.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 0, Face.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            ...
                            if Selected then
                                if
                                    Face.TextureIndex >
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 0, Face.Index) - 1)
                                 then
                                    Face.TextureIndex = 0
                                else
                    ...
                    RageUI.List(
                        ...
                        Mask.Index,
                        "Texture Index: " ..
                            Mask.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 1, Mask.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Mask.Index = Index
                            ...
                            if Selected then
                                if
                                    Mask.TextureIndex >
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 1, Mask.Index) - 1)
                                 then
                                    Mask.TextureIndex = 1
                                else
                    ...
                    RageUI.List(
                        ...
                        Hair.Index,
                        "Texture Index: " ..
                            Hair.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 2, Hair.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Hair.Index = Index
                            ...
                            if Selected then
                                if
                                    Hair.TextureIndex >=
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 2, Hair.Index) - 1)
                                 then
                                    Hair.TextureIndex = 0
                                else
                    ...
                    RageUI.List(
                        ...
                        Torso.Index,
                        "Texture Index: " ..
                            Torso.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 3, Torso.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Torso.Index = Index
                            ...
                            if Selected then
                                if
                                    Torso.TextureIndex >
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 3, Torso.Index) - 1)
                                 then
                    ...
                    RageUI.List(
                        ...
                        Legs.Index,
                        "Texture Index: " ..
                            Legs.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 4, Legs.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Legs.Index = Index
                            ...
                            if Selected then
                                if
                                    Legs.TextureIndex >
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 4, Legs.Index) - 1)
                                 then
                                    Legs.TextureIndex = 1
                                else
                    ...
                    RageUI.List(
                        ...
                        Parachute.Index,
                        "Texture Index: " ..
                            Parachute.TextureIndex ..
                                "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 5, Parachute.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            ...
                            if Selected then
                                if
                                    Parachute.TextureIndex >
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 5, Parachute.Index) - 1)
                                 then
                    ...
                    RageUI.List(
                        ...
                        Shoes.Index,
                        "Texture Index: " ..
                            Shoes.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 6, Shoes.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Shoes.Index = Index
                            ...
                            if Selected then
                                if
                                    Shoes.TextureIndex >
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 6, Shoes.Index) - 1)
                                 then
                    ...
                    RageUI.List(
                        ...
                        Accessory.Index,
                        "Texture Index: " ..
                            Accessory.TextureIndex ..
                                "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 7, Accessory.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            ...
                            if Selected then
                                if
                                    Accessory.TextureIndex >
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 7, Accessory.Index) - 1)
                                 then
                    ...
                    RageUI.List(
                        ...
                        Undershirt.Index,
                        "Texture Index: " ..
                            Undershirt.TextureIndex ..
                                "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 8, Undershirt.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            ...
                            if Selected then
                                if
                                    Undershirt.TextureIndex >
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 8, Undershirt.Index) - 1)
                                 then
                    ...
                    RageUI.List(
                        ...
                        "Texture Index: " ..
                            Kevlar.TextureIndex ..
                                "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 9, Kevlar.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Kevlar.Index = Index
                            ...
                            if Selected then
                                if
                                    Kevlar.TextureIndex >
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 9, Kevlar.Index) - 1)
                                 then
                    ...
                    RageUI.List(
                        ...
                        Badge.Index,
                        "Texture Index: " ..
                            Badge.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 10, Badge.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Badge.Index = Index
                            ...
                            if Selected then
                                if
                                    Badge.TextureIndex >=
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 10, Badge.Index) - 1)
                                 then
                    ...
                    RageUI.List(
                        ...
                        "Texture Index: " ..
                            Torso2.TextureIndex ..
                                "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 11, tonumber(Torso2.Index)),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Torso2.Index = Index
                            ...
                            if Selected then
                                if
                                    Torso2.TextureIndex >=
                                        (GetNumberOfPedTextureVariations(PlayerPedId(), 11, Torso2.Index) - 1)
                                 then
                    ...
                    RageUI.List(
                        ...
                        "Texture Index: " ..
                            Hats.TextureIndex ..
                                "/" .. GetNumberOfPedPropTextureVariations(PlayerPedId(), 0, Hats.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Hats.Index = Index
                            ...
                            if Selected then
                                if
                                    Hats.TextureIndex >=
                                        (GetNumberOfPedPropTextureVariations(PlayerPedId(), 0, Hats.Index) - 1)
                                 then
                                    Hats.TextureIndex = 0
                                else
                    ...
                    RageUI.List(
                        ...
                        Glasses.Index,
                        "Texture Index: " ..
                            Glasses.TextureIndex ..
                                "/" .. GetNumberOfPedPropTextureVariations(PlayerPedId(), 1, Glasses.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Glasses.Index = Index
                            ...
                            if Selected then
                                if
                                    Glasses.TextureIndex >=
                                        (GetNumberOfPedPropTextureVariations(PlayerPedId(), 1, Glasses.Index) - 1)
                                 then
                    ...
                    RageUI.List(
                        ...
                        Earings.Index,
                        "Texture Index: " ..
                            Earings.TextureIndex ..
                                "/" .. GetNumberOfPedPropTextureVariations(PlayerPedId(), 2, Earings.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Earings.Index = Index
                            ...
                            if Selected then
                                if
                                    Earings.TextureIndex >=
                                        (GetNumberOfPedPropTextureVariations(PlayerPedId(), 2, Earings.Index) - 1)
                                 then
                    ...
                    RageUI.List(
                        ...
                        Watches.Index,
                        "Texture Index: " ..
                            Watches.TextureIndex ..
                                "/" .. GetNumberOfPedPropTextureVariations(PlayerPedId(), 6, Watches.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            Watches.Index = Index
                            ...
                            if Selected then
                                if
                                    Watches.TextureIndex >=
                                        (GetNumberOfPedPropTextureVariations(PlayerPedId(), 6, Watches.Index) - 1)
                                 then
                    ...
                    RageUI.List(
                        ...
                        Bracelets.Index,
                        "Texture Index: " ..
                            Bracelets.TextureIndex ..
                                "/" .. GetNumberOfPedPropTextureVariations(PlayerPedId(), 7, Bracelets.Index),
                        {},
                        true,
                        function(Hovered, Active, Selected, Index)
                            ...
                            if Selected then
                                if
                                    Bracelets.TextureIndex >=
                                        (GetNumberOfPedPropTextureVariations(PlayerPedId(), 7, Bracelets.Index) - 1)
                                 then
