...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get("Housing", "main")) then
    ...
    elseif RageUI.Visible(RMenu:Get("Housing", "leave")) then
        RageUI.DrawContent({header = true, glare = false, instructionalButton = true}, function()
    ...
    elseif RageUI.Visible(RMenu:Get("Housing", "wardrobe")) then
        RageUI.DrawContent({header = true, glare = false, instructionalButton = true}, function()
    ...
    elseif RageUI.Visible(RMenu:Get("Housing", "wardrobesub")) then
        RageUI.DrawContent({header = true, glare = false, instructionalButton = true}, function()
