...
RMenu.Add("vRPGarages", "main", RageUI.CreateMenu("", "~w~Nova Garage Menu", 1300, 50, "garages", "garages"))
...
RMenu.Add(
    "vRPGarages",
    "buy_vehicles_submenu_manage",
    RageUI.CreateSubMenu(RMenu:Get("vRPGarages", "buy_vehicles_submenu"))
)
RMenu.Add("vRPGarages", "owned_vehicles_submenu", RageUI.CreateSubMenu(RMenu:Get("vRPGarages", "owned_vehicles")))
RMenu.Add(
    "vRPGarages",
    "owned_vehicles_submenu_manage",
    RageUI.CreateSubMenu(RMenu:Get("vRPGarages", "owned_vehicles_submenu"))
)
RMenu.Add(
    "vRPGarages",
    "scrap_vehicle_confirmation",
    RageUI.CreateSubMenu(RMenu:Get("vRPGarages", "owned_vehicles_submenu_manage"))
)
RMenu.Add("vRPGarages", "rented_vehicles_out_manage", RageUI.CreateSubMenu(RMenu:Get("vRPGarages", "rented_vehicles")))
RMenu.Add(
    "vRPGarages",
    "rented_vehicles_out_manage_submenu",
    RageUI.CreateSubMenu(RMenu:Get("vRPGarages", "rented_vehicles_out_manage"))
)
                    ...
                    if IsPedInAnyVehicle(PlayerPedId(), false) then
                        ...
                        if vRPConfig.EnableBuyVehicles then
                            RageUI.Button(
                                ...
                                RMenu:Get("vRPGarages", "buy_vehicles")
                            )
                        end
                        ...
                        RageUI.Button(
                            ...
                            RMenu:Get("vRPGarages", "owned_vehicles")
                        )
                        ...
                        RageUI.Button(
                            ...
                            RMenu:Get("vRPGarages", "rented_vehicles")
                        )
                    end
                    RageUI.Button(
                        "Store Vehicle",
                    ...
                    for i, v in pairs(VehiclesFetchedTable) do
                        if garage_type == VehiclesFetchedTable[i].config.vtype then
                            RageUI.Button(
                                ...
                                RMenu:Get("vRPGarages", "buy_vehicles_submenu")
                            )
                        end
                    end
                end
                        ...
                        RageUI.Button(
                            ...
                            function(Hovered, Active, Selected)
                                if Selected then
                                    ...
                                    RMenu:Get("vRPGarages", "buy_vehicles_submenu_manage"):SetSubtitle(
                                        "~w~" .. v[1] .. " Price: $" .. v[2]
                                    )
                                end
                                if Active then
                            ...
                            RMenu:Get("vRPGarages", "buy_vehicles_submenu_manage")
                        )
                    end
                end
            )
                    ...
                    for i, v in pairs(VehiclesFetchedTable) do
                        if garage_type == VehiclesFetchedTable[i].config.vtype then
                            RageUI.Button(
                                ...
                                RMenu:Get("vRPGarages", "owned_vehicles_submenu")
                            )
                        end
                    end
                end
                ...
                function()
                    for i, v in pairs(selected_category) do
                        if RentedVeh then
                            RageUI.Button(
                                v[1],
                                v[2] .. " until the vehicle is returned.",
                                {},
                                true,
                                function(Hovered, Active, Selected)
                                    if Selected then
                                        SelectedCar.spawncode = i
                                        SelectedCar.name = v[1]
                                        RMenu:Get("vRPGarages", "owned_vehicles_submenu_manage"):SetSubtitle(
                                            "~w~" .. v[1]
                                        )
                                    end
                                    if Active then
                                ...
                                RMenu:Get("vRPGarages", "owned_vehicles_submenu_manage")
                            )
                        else
                            RageUI.Button(
                                v[1],
            ...
            RageUI.DrawContent(
                ...
                function()
                    RageUI.Button(
                        ...
                        function(Hovered, Active, Selected)
                            if Selected then
                                tvRP.spawnGarageVehicle(
                                    garage_type,
                                    SelectedCar.spawncode,
            ...
            RageUI.DrawContent(
                ...
                function()
                    ...
                    RageUI.Button(
                        ...
                        RMenu:Get("vRPGarages", "rented_vehicles_out_manage")
                    )
                    RageUI.Button(
                        "Rented Vehicles In",
                        nil,
                        ...
                        RMenu:Get("vRPGarages", "rented_vehicles_manage")
                    )
                end
            )
        end
                    ...
                    for i, v in pairs(VehiclesFetchedTable) do
                        if garage_type == VehiclesFetchedTable[i].config.vtype then
                            RageUI.Button(
                                ...
                                RMenu:Get("vRPGarages", "rented_vehicles_out_manage_submenu")
                            )
                        end
                    end
                end
            ...
            RageUI.DrawContent(
                ...
                function()
                    for i, v in pairs(selected_category) do
                        RageUI.Button(
                            v[1] .. " Rented to: " .. v[3],
                            v[2] .. " until the vehicle is returned to you.",
                            {},
                            true,
                            function(Hovered, Active, Selected)
                            end
        ...
        function()
            while true do
                ...
                if Hovered_Vehicles then
                    ...
                    if
                        not DoesEntityExist(veh) and not IsPedInAnyVehicle(PlayerPedId(), false) and
                            not cantload[Hovered_Vehicles] and
                            Hovered_Vehicles
                     then
                        local i = 0
