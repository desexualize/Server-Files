...
vRPConfig.EnableComa = false -- Controls the vRP coma on death.
...
vRPConfig.AdminCooldownTime = 30 -- 1 minute in (seconds) duration of cooldown.
...
vRPConfig.ServerName = "Nova UK" -- Controls the name that is displayed on warnings title etc.
vRPConfig.PlayerSavingTime = 500 -- Time in milliseconds to update Player saving
---------------
