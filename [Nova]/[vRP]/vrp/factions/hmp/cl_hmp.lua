...
local hmp = false
local hmp_permission = false
local hmp_suspended = false

-- set player as hmp (true or false)
function tvRP.setHMP(flag)
  hmp = flag
...
function tvRP.Set_HMP_Permission(flag)
  hmp_permission = flag
end

function tvRP.Has_HMP_Permission()
  return hmp_permission
end

function tvRP.Set_HMP_Suspended(flag)
  hmp_suspended = flag
end

function tvRP.Is_HMP_Suspended()
  return flag
end
