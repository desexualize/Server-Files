...
exports('Get_Users_By_Permission', function(permission, callback)
...
exports('Remove_User_Group', function(user_id, group)
    vRP.removeUserGroup(user_id, group)
    TriggerEvent('Nova:Server:GroupsUpdated', user_id)
end)

exports('Add_User_Group', function(user_id, group)
