function starter(_, arg)
    ...
    MySQL.Sync_Query("vRP/get_vehicle", {user_id = user_id, vehicle ="sanchez"}, function(pvehicle, affected)
	

			
        vRP.getUserIdentity(user_id, function(identity)					
            MySQL.Execute_Command("vRP/add_vehicle", {user_id = user_id, vehicle = "sanchez", registration = "P "..identity.registration})
...
function amazon(_, arg)
    ...
    MySQL.Sync_Query("vRP/get_vehicle", {user_id = user_id, vehicle = '300kg'}, function(pvehicle, affected)
  


            vRP.getUserIdentity(user_id, function(identity)
                MySQL.Execute_Command("vRP/add_vehicle", {user_id = user_id, vehicle = '300kg', registration = "P "..identity.registration})
