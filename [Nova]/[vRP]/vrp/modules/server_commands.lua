RegisterCommand('addgroup', function(source, args)
    ...
    if tonumber(args[1]) and args[2] then
        ...
        TriggerEvent('Nova:Server:DutyMenu:GetWhitelistedFactions', vRP.getUserSource(userid))
...
RegisterCommand('removegroup', function(source, args)
    ...
    if tonumber(args[1]) and args[2] then
        ...
        TriggerEvent('Nova:Server:DutyMenu:GetWhitelistedFactions', vRP.getUserSource(userid), group)
