function NovaDrugsServer.WeedGather()
...
function NovaDrugsServer.CanProcessWeed()
    local user_id = vRP.getUserId({source})
...
function NovaDrugsServer.ProcessWeed()
    local user_id = vRP.getUserId({source})
...
function NovaDrugsServer.SellWeed(amount)
    local user_id = vRP.getUserId({source})
