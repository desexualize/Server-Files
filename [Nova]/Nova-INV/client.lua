...
AddEventHandler('openBoot', function()
    ...
    if VehInRadius and IsPedInAnyVehicle(PlayerPedId(), false) == false then 
        ...
        TriggerServerEvent('Nova:FetchTrunkInventory', NVeh, NetworkGetNetworkIdFromEntity(nearestVeh))
    else
...
RegisterCommand('inventory', function()
    if not tvRP.isInComa({}) then
        if not inventoryOpen then
            TriggerServerEvent('Nova:FetchPersonalInventory')
            inventoryOpen = true; 
...
-- 
            ...
            --     inventoryType = 'CarBoot'
            --     
            --     TriggerServerEvent('Nova:FetchTrunkInventory', NVeh)
            -- end
            ...
            if IsLootBagOpening then
                ...
                TriggerServerEvent('Nova:CloseLootbag')
...
RegisterNetEvent('Nova:InventoryOpen')
AddEventHandler('Nova:InventoryOpen', function(toggle, lootbag)
...
RegisterNetEvent('Nova:ToggleNUIFocus')
AddEventHandler('Nova:ToggleNUIFocus', function(value)
    --print('focus', value)
    SetNuiFocus(value, value)
    SetNuiFocusKeepInput(value)
end)

RegisterNetEvent('Nova:SendSecondaryInventoryData')
AddEventHandler('Nova:SendSecondaryInventoryData', function(InventoryData, CurrentKG, MaxKg)
...
AddEventHandler('Nova:FetchPersonalInventory', function(table, CurrentKG, MaxKG)
...
RegisterNUICallback('UseBtn', function(data, cb)
    TriggerServerEvent('Nova:UseItem', data.itemId, data.invType)
    cb(true);
...
RegisterNUICallback('TrashBtn', function(data, cb)
    TriggerServerEvent('Nova:TrashItem', data.itemId, data.invType)
    cb(true);
    PlaySound(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
end)

RegisterNUICallback('GiveBtn', function(data, cb)
    TriggerServerEvent('Nova:GiveItem', data.itemId, data.invType)
    cb(true)
    PlaySound(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
end)
...
RegisterNUICallback('MoveBtn', function(data, cb)
    if not IsLootBagOpening then
        TriggerServerEvent('Nova:MoveItem', data.invType, data.itemId, VehTypeA)
    else 
        TriggerServerEvent('Nova:MoveItem', 'LootBag', data.itemId, LootBagIDNew)
    end
    PlaySound(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
    cb(true)
end)
...
RegisterNUICallback('MoveXBtn', function(data, cb)
    if not IsLootBagOpening then
        TriggerServerEvent('Nova:MoveItemX', data.invType, data.itemId, VehTypeA)
    else 
        TriggerServerEvent('Nova:MoveItemX', 'LootBag', data.itemId, LootBagIDNew)
    end
    PlaySound(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
    cb(true)
end)
...
RegisterNUICallback('MoveAllBtn', function(data, cb)
    if not IsLootBagOpening then
        ...
        TriggerServerEvent('Nova:MoveItemAll', data.invType, data.itemId, VehTypeA, NetworkGetNetworkIdFromEntity(nearestVeh2))
    else 
        TriggerServerEvent('Nova:MoveItemAll', 'LootBag', data.itemId, LootBagIDNew)
    end
    PlaySound(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
    cb(true)
end)
...
RegisterNetEvent('Nova:LockPick2')
AddEventHandler('Nova:LockPick2', function()
    TriggerServerEvent('Nova:LockPick')
end)

RegisterNetEvent('Nova:whatIsThis')
AddEventHandler('Nova:whatIsThis', function()
        ...
        hasDoneIt = false
               ...
               if chance == 3 then
                   ...
                   --
                       ...
                       TriggerServerEvent('Nova:FetchTrunkInventory', GetEntityArchetypeName(nearestVeh), NetworkGetNetworkIdFromEntity(nearestVeh))
