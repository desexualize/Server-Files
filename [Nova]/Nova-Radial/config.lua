...
--RegisterNetEvent("Nova:PoliceClockedOn")
--AddEventHandler("Nova:PoliceClockedOn", function(MetPD)
--    onduty = MetPD
--end)
...
newSubMenus = {
    ...
    --     functionName = "Nova:ComingSoon"
    -- },
    ["vehmenu:lockpick"] = {
        title = "Lockpick Vehicle",
        icon = "#general-keys-give",
        functionName = "Nova:LockPick2"
    },
    ["general:exitmenu"] = {
        title = "Exit Menu",
    ...
    ["police:cpr"] = {
        ...
        functionName = "NovaClient:ReviveCPR"
    },
    ["vehmenupd:openboot"] = {
        title = "Search Boot",
        icon = "#vehicle-options-vehicle",
    ...
    ["vehmenupd:clampveh"] = {
        title = "Clamp Vehicle",
        icon = "#car-side",
        functionName = "Nova:ClampVehicle"
    },
    ["vehmenupd:unclampveh"] = {
        title = "Unclamp Vehicle",
        icon = "#car-side",
        functionName = "Nova:UnClampVehicles"
    },
    ["general:exitmenu"] = {
        title = "Exit Menu",
        icon = "#animation-hurry",
    ...
    ["general:emotes"] = {
        title = "Store Weapons",
        icon = "#general-emotes",
        functionName = "Nova:Storeweapons"
    },
    ["general:askid"] = {
        title = "Ask For ID",
        icon = "#police-vehicle-plate",
        functionName = "Nova:AskID"
    },
    ["general:searchnearest"] = {
        title = "Search Player",
        icon = "#cuffs-check-inventory",
        functionName = "Nova:SearchNearest"
    },
    ...
    ["cuffs:cuff"] = {
        title = "Cuff",
        icon = "#cuffs-cuff",
        functionName = "Nova:policeCuff"
    },
    ["police:jail"] = {
        title = "Jail Near",
        icon = "#cuffs-cuff",
        functionName = "Nova:Jail"
    },
    ["police:unjail"] = {
        title = "Unjail Player",
        icon = "#cuffs-uncuff",
        functionName = "Nova:Unjail"
    },
    ["police:fine"] = {
        title = "Fine Nearest",
        icon = "#animation-money",
        functionName = "Nova:Fine"
    },
    ["police:seize"] = {
        title = "Seize Weapons",
        icon = "#police-action-remove-weapons",
        functionName = "Nova:SeizeWeapons"
    },
    ["police:seizeitems"] = {
        title = "Seize Items",
        icon = "#police-action-remove-weapons",
        functionName = "Nova:SeizeItems"
    },
    ["cuffs:softcuff"] = {
        title = "Soft Cuff",
        icon = "#cuffs-cuff",
    ...
    ["police:escort"] = {
        title = "Drag Player",
        icon = "#general-escort",
        functionName = "Nova:policeDrag"
    },
    ["police:putinvehicle"] = {
        title = "Put In Vehicle",
        icon = "#general-put-in-veh",
        functionName = "Nova:putinveh"
    },
    ["police:unseatnearest"] = {
        title = "Unseat Player",
        icon = "#general-unseat-nearest",
        functionName = "Nova:takeoutveh"
    },
    ["police:cuff"] = {
        title = "Cuff",
        icon = "#cuffs-cuff",
...
AddEventHandler(
    "drivingInstructor:instructorToggle",
    function(mode)
...
AddEventHandler(
    "police:currentHandCuffedState",
    function(pIsHandcuffed, pIsHandcuffedAndWalking)
