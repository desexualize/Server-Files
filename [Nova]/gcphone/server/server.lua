...
function _internalAddMessage(transmitter, receiver, message, owner)
    local Query =
        "INSERT INTO phone_messages (`transmitter`, `receiver`,`message`, `isRead`,`owner`) VALUES(@transmitter, @receiver, @message, @isRead, @owner);"
                        ...
                        vRPclient.notify(
                            source,
                            {
                                "~g~Successfully transfered: ~w~£" ..
                                    amount ..
                                        " ~g~to ~w~" ..
                                            vRP.getPlayerName({reciever}) .. " ~r~ ~n~ ~n~[ID: ~w~" .. num .. " ~r~]"
                            }
                        )
                        ...
                        vRPclient.notify(
                            reciever,
                            {
                                "~g~You have recieved: ~w~£" ..
                                    amount ..
                                        "~g~ from ~w~" ..
                                            vRP.getPlayerName({source}) .. " ~r~ ~n~ ~n~[ID: ~w~" .. userid .. " ~r~]"
                            }
                        )
