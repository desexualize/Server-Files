                ...
                if amount > 0 then
                    ...
                    if user_id ~= nil then
                        if vRP.tryWithdraw(user_id, amount) then
                            ...
                            webhook = "https://discord.com/api/webhooks/930534372220735569/k41kLL6WQrXDosIQTcqA4l10Pcr_GuDQcHWcMS_JV08HUwlcnkLRij2jnlnaGRd8VzcF"
...
AddEventHandler('VRP:DepositAll', function()
    local source = source  
    local ped = GetPlayerPed(source)
    local playerCoords = GetEntityCoords(ped)
    for i, v in pairs(cfg.atms) do
