...
if (IsPedSittingInAnyVehicle(ped)) then return
elseif GetGameTimer() > (startemote+2500) then
startemote = GetGameTimer()
EmoteCommandStart(source, args, raw)
else 
Notify("~r~This Emote has a cooldown.")
end
end)
