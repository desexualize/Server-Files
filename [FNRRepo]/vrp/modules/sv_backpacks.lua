--[[local backpacksv = {
    ["Legion Store"] = {
        ["_config"] = {130.5684, -1034.9497, 28.5554, 676, 1, "Legion Store Bags", "", true},
    ...
    ["Rebel"] = {
        ["_config"] = {1540.7928, 6332.4702, 23.0719, 676, 1, "Rebel Backpacks", "rebel.license", true},
...
AddEventHandler("playerConnecting", function()
    ...
    TriggerClientEvent('FNR:getBackPacks', source,backpacksv)
end)]]