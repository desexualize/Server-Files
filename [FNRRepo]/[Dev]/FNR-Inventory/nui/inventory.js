...
window.addEventListener('message', function(event) {
    ...
    if (msg.action == "loadItems") {
        ...
        if (msg.CurrentKG < 14) {
            $('#PersonalInventoryWeight').css('color', 'green'); // Fails
        } else if (msg.CurrentKG > (msg.MaxKG/2) && !(msg.CurrentKG > (msg.MaxKG-(msg.MaxKG/3)))) {
            $('#PersonalInventoryWeight').css('color', 'yellow');
        } else if (msg.CurrentKG > (msg.MaxKG-(msg.MaxKG/3))) {
