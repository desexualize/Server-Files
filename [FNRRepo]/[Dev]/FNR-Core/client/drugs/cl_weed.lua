        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              FNRcfgdrugsServer.CanProcessWeed({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then

          


                  FNRcfgdrugsServer.ProcessWeed()
...
function sellingWeedUnits()
    FNRcfgdrugsServer.SellWeed({tonumber(1)})
    return false
end
