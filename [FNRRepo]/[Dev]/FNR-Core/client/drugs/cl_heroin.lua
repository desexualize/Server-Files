          ...
          while InRangeGather do
            ...
            if IsControlJustReleased(0, 51)  then
              if not pedinveh then
                ...
                FNRcfgdrugsServer.HeroinGather ()
                Action = false
              else
        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              FNRcfgdrugsServer.CanProcessHeroin({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  FNRcfgdrugsServer.ProcessHeroin()
...
function sellingHeroinUnits()
    FNRcfgdrugsServer.SellHeroin({tonumber(1)})
    return false
end
