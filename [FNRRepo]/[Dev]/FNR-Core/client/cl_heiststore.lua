...
-- RMenu.Add("FNR:HeistShops", "main", RageUI.CreateMenu("Heist Store", "~b~Heist Store", 1350, 50))
-- RMenu.Add("FNR:HeistShops", "sub", RageUI.CreateSubMenu(RMenu:Get("FNR:HeistShops", "main"), "Heist Store", "~b~Confirm Purchase", 1350, 50))

-- RageUI.CreateWhile(1.0, RMenu:Get("FNR:HeistShops", "main"), nil, function()
--     RageUI.IsVisible(RMenu:Get("FNR:HeistShops", "main"), true, false, true, function()
...
--                     end
--                 end, RMenu:Get("FNR:HeistShops", "sub", true))
--             end
--         end
--     end, function() 
--     end)

--     RageUI.IsVisible(RMenu:Get("FNR:HeistShops", "sub"), true, false, true, function()
...
--                 if Selected then
--                     TriggerServerEvent("FNR:SellHeistItem", currentItemID, amount)
--                 end
--             end, RMenu:Get("FNR:HeistShops", "main", true))
--         else
...
--                 if Selected then
--                     TriggerServerEvent("FNR:BuyHeistItem", currentItemID, amount)
--                 end
--             end, RMenu:Get("FNR:HeistShops", "main", true))
--         end
...
--                 inMenu = true
--                 currentShop = k
--                 RageUI.Visible(RMenu:Get("FNR:HeistShops", "main"), true)
--             end
--         end
