...
RegisterNetEvent('FNR:TakenTurf')
AddEventHandler('FNR:TakenTurf', function(isnTurf)
...
RegisterNetEvent('FNR:OutOfZone')
AddEventHandler('FNR:OutOfZone', function(isnTurf)
	inTurf = false

	-- TriggerEvent('chatMessage', '[FNR Turf System]:', {255, 34, 0}, "The turf cap was cancelled, you will receive nothing.")
...
RegisterNetEvent('FNR:PlayerDied')
AddEventHandler('FNR:PlayerDied', function(isnTurf)
	inTurf = false
	-- TriggerEvent('chatMessage', '[FNR Turf System]:', {255, 34, 0}, "The turf cap was cancelled, you died!")
...
RegisterNetEvent('FNR:TurfComplete')
AddEventHandler('FNR:TurfComplete', function(reward, name)
	inTurf = false
	-- TriggerEvent('chatMessage', '[FNR Turf System]:', {255, 34, 0}, "Turf capture sucessful, you received:^2 £" .. reward)
