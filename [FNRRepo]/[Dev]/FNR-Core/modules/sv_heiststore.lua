...
-- RegisterNetEvent("FNR:BuyHeistItem")
-- AddEventHandler("FNR:BuyHeistItem", function(itemID, amount)
...
-- RegisterNetEvent("FNR:SellHeistItem")
-- AddEventHandler("FNR:SellHeistItem", function(itemID, amount)
--     local user_id = vRP.getUserId({source})
