...
local maxHighRollersBet = 100000000000000000000000
                                        ...
                                        while nextCardCount >= 1 do
                                            ...
                                            if blackjackGameData[gameId][source][2][nextCardCount] == true then --if hit 
                                                ...
                                                if currentHand > 21 then
                                                    ...
                                                    local webhook = "https://discord.com/api/webhooks/1027270204121690173/EpWtoqA3HTg7bnIDMLCtvG-rsYS3b6XFjakVb-jtZ5WG_FiP7-jPFrYnKyTf02Hehzi0"
