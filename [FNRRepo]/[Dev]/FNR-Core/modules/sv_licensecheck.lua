    ...
    if vRP.hasPermission({userid, permission}) then 
        vRPclient.getNearestPlayer(player,{10},function(nplayer)
            ...
            elseif vRP.hasGroup({target, license}) then 
                ...
                local webhook = "https://discordapp.com/api/webhooks/995058047892328529/lAXRZdrn2IBF8X_U_6G6PRV75AX9g34z_A1gFNopxPI6EvbvjHqkrE5lZgFVRHDf33uN"
