...
RegisterNUICallback('updateSkin', function(data)
	...
	if v == true then
		...
		TriggerServerEvent("FNR:saveFaceData",faceSaveData)
	end
end)
...
RegisterNetEvent("FNR:setHairstyle")
AddEventHandler("FNR:setHairstyle",function(hairstyle)
    if hairstyle then
...
Citizen.CreateThread(function()
	...
	for k, v in pairs(FNRFaceDataBlips) do
