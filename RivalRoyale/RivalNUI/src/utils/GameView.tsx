...
const createProgram = (gl: WebGLRenderingContext) => {
  const vertexShader: any = makeShader(gl, gl.VERTEX_SHADER, vertexShaderSrc);
  const fragmentShader: any = makeShader(gl, gl.FRAGMENT_SHADER, fragmentShaderSrc);
...
export const createGameView = (canvas: HTMLCanvasElement | null) => {
