...
function RageUI.CreateMenuMouse(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
function RageUI.CreateSubMenuMouse(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
