...
RegisterNetEvent("AQUA:Announce")
AddEventHandler(
    "AQUA:Announce",
    function(d)
        if d ~= nil then
            CreateThread(
                function()
                    ...
                    BeginScaleformMovieMethod(scaleform, "SHOW_SHARD_MIDSIZED_MESSAGE")
                    ScaleformMovieMethodAddParamTextureNameString("~y~AQUA Announcement")
...
RegisterNetEvent(
    "AQUA:smallAnnouncement",
    function(f, g, h, i)
        AQUA.announceMpSmallMsg(f, g, h, i)
    end
)
function AQUA.announceMpSmallMsg(f, g, h, i)
