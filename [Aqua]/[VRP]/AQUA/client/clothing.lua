...
RMenu.Add('AQUAClothing', 'main', RageUI.CreateMenu("", "~d~ Clothing Menu",1300, 100, "banners", "clothes"))
RMenu.Add('AQUAClothing', 'clothingsubmenu',  RageUI.CreateSubMenu(RMenu:Get("AQUAClothing", "main")))
RMenu.Add('AQUAClothing', 'changegendersubmenu',  RageUI.CreateSubMenu(RMenu:Get("AQUAClothing", "main")))
RMenu.Add('AQUAClothing', 'changepedmenu',  RageUI.CreateSubMenu(RMenu:Get("AQUAClothing", "main")))
RMenu.Add('AQUAClothing', 'wardrobesub',  RageUI.CreateSubMenu(RMenu:Get("AQUAClothing", "main")))
RMenu.Add('wardrobesub', 'clothingsub',  RageUI.CreateSubMenu(RMenu:Get("AQUAClothing", "wardrobesub")))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('AQUAClothing', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.ButtonWithStyle("Change Clothing", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("AQUAClothing", "clothingsubmenu"))
            RageUI.ButtonWithStyle("Change Gender", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("AQUAClothing", "changegendersubmenu"))
            RageUI.ButtonWithStyle("Change Ped", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("AQUAClothing", "changepedmenu"))
            --RageUI.ButtonWithStyle("Wardrobe", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("AQUAClothing", "wardrobesub"))
        end)
    end
    if RageUI.Visible(RMenu:Get('AQUAClothing', 'changegendersubmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.ButtonWithStyle("Female", nil, {}, true, function(Hovered, Active, Selected) 
                if Selected then 
            ...
            end,RMenu:Get("AQUAClothing", "changegendersubmenu"))
            RageUI.ButtonWithStyle("Male", nil, {}, true, function(Hovered, Active, Selected) 
                if Selected then
    ...
    if RageUI.Visible(RMenu:Get('AQUAClothing', 'wardrobesub')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('wardrobesub', 'clothingsub')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            end, RMenu:Get('AQUAClothing', 'wardrobesub'))
    ...
    if RageUI.Visible(RMenu:Get('AQUAClothing', 'changepedmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('AQUAClothing', 'clothingsubmenu')) then
...
Citizen.CreateThread(function()
    while true do 
        ...
        if not MenuOpen and inMarker then 
            MenuOpen = true
            RageUI.Visible(RMenu:Get('AQUAClothing', 'main'), true) 
            Face.Index = GetPedDrawableVariation(ped, 0)
            Face.TextureIndex = GetPedTextureVariation(ped, 0)
            Mask.Index = GetPedDrawableVariation(ped, 1)
            Mask.TextureIndex = GetPedTextureVariation(ped, 1)
        ...
        if not inMarker and MenuOpen then
            ...
            RageUI.Visible(RMenu:Get('AQUAClothing', 'clothingsubmenu'), false)
            RageUI.Visible(RMenu:Get('AQUAClothing', 'changegendersubmenu'), false)  
            RageUI.Visible(RMenu:Get('AQUAClothing', 'main'), false)
            MenuOpen = false
        end
    end
end)