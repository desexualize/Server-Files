...
allIpls = {
  ...
  {
      interiorsProps = {"V_FIB03_door_light", "V_FIB02_set_AH3b", "V_FIB03_set_AH3b", "V_FIB04_set_AH3b"},
  ...
  },
  {
      ...
      coords = {
          {-141.1987, -620.913, 168.8205},
          {-141.5429, -620.9524, 168.8204},
          {-141.2896, -620.9618, 168.8204},
          {-141.4966, -620.8292, 168.8204},
          {-141.3997, -620.9006, 168.8204},
          {-141.5361, -620.9186, 168.8204},
          {-141.392, -621.0451, 168.8204},
          {-141.1945, -620.8729, 168.8204},
          {-141.4924, -621.0035, 168.8205},
          {-75.8466, -826.9893, 243.3859},
          {-75.49945, -827.05, 243.386},
          {-75.49827, -827.1889, 243.386},
          {-75.44054, -827.1487, 243.3859},
          {-75.63942, -827.1022, 243.3859},
          {-75.47446, -827.2621, 243.386},
          {-75.56978, -827.1152, 243.3859},
          {-75.51953, -827.0786, 243.3859},
          {-75.41915, -827.1118, 243.3858},
          ...
          {-1392.667, -480.4736, 72.04217},
          {-1392.542, -480.4011, 72.04211},
          {-1392.626, -480.4856, 72.04212},
          {-1392.617, -480.6363, 72.04208},
          {-1392.532, -480.7649, 72.04207},
          {-1392.611, -480.5562, 72.04214},
          {-1392.563, -480.549, 72.0421},
          {-1392.528, -480.475, 72.04206},
          {-1392.416, -480.7485, 72.04207}
      }
  },
  {
      interiorsProps = {
  ...
  {interiorsProps = {"floor_vinyl_03"}, coords = {{730.63916015625, -2993.2373046875, -38.999904632568}}},
  {
      interiorsProps = {
          "chair01",
          "chair02",
...
Citizen.CreateThread(function()
  loadImportExportDlc()
  for a, b in pairs(allIpls) do
      loadInt(b.coords, b.interiorsProps)
  end
end)
function loadInt(c, d)
  for a, e in pairs(c) do
      local interiorID = GetInteriorAtCoords(e[1], e[2], e[3])
      PinInteriorInMemory(interiorID)
      for a, f in pairs(d) do
          Citizen.Wait(25)
          ActivateInteriorEntitySet(interiorID, f)
      end
  end
end
...
if IsValidInterior(interiorID) then
  ActivateInteriorEntitySet(interiorID, "set_int_02_decal_01")
  ActivateInteriorEntitySet(interiorID, "set_int_02_lounge1")
  ActivateInteriorEntitySet(interiorID, "set_int_02_cannon")
  ActivateInteriorEntitySet(interiorID, "set_int_02_clutter1")
  ActivateInteriorEntitySet(interiorID, "set_int_02_crewemblem")
  ActivateInteriorEntitySet(interiorID, "set_int_02_shell")
  ActivateInteriorEntitySet(interiorID, "set_int_02_security")
  ActivateInteriorEntitySet(interiorID, "set_int_02_sleep")
  ActivateInteriorEntitySet(interiorID, "set_int_02_trophy1")
  ActivateInteriorEntitySet(interiorID, "set_int_02_paramedic_complete")
  ActivateInteriorEntitySet(interiorID, "set_Int_02_outfit_paramedic")
  ActivateInteriorEntitySet(interiorID, "set_Int_02_outfit_serverfarm")
  SetInteriorEntitySetColor(interiorID, "set_int_02_decal_01", 1)
  SetInteriorEntitySetColor(interiorID, "set_int_02_lounge1", 1)
  SetInteriorEntitySetColor(interiorID, "set_int_02_cannon", 1)
  SetInteriorEntitySetColor(interiorID, "set_int_02_clutter1", 1)
  SetInteriorEntitySetColor(interiorID, "set_int_02_shell", 1)
  SetInteriorEntitySetColor(interiorID, "set_int_02_security", 1)
  SetInteriorEntitySetColor(interiorID, "set_int_02_sleep", 1)
  SetInteriorEntitySetColor(interiorID, "set_int_02_trophy1", 1)
  SetInteriorEntitySetColor(interiorID, "set_int_02_paramedic_complete", 1)
  SetInteriorEntitySetColor(interiorID, "set_Int_02_outfit_paramedic", 1)
  SetInteriorEntitySetColor(interiorID, "set_Int_02_outfit_serverfarm", 1)
end
interiorID = GetInteriorAtCoords(-1266.0, -3014.0, -47.0)
if IsValidInterior(interiorID) then
  ActivateInteriorEntitySet(interiorID, "set_lighting_hangar_a")
  ActivateInteriorEntitySet(interiorID, "set_tint_shell")
  ActivateInteriorEntitySet(interiorID, "set_bedroom_tint")
  ActivateInteriorEntitySet(interiorID, "set_crane_tint")
  ActivateInteriorEntitySet(interiorID, "set_modarea")
  ActivateInteriorEntitySet(interiorID, "set_lighting_tint_props")
  ActivateInteriorEntitySet(interiorID, "set_floor_1")
  ActivateInteriorEntitySet(interiorID, "set_floor_decal_1")
  ActivateInteriorEntitySet(interiorID, "set_bedroom_modern")
  ActivateInteriorEntitySet(interiorID, "set_office_modern")
  ActivateInteriorEntitySet(interiorID, "set_bedroom_blinds_open")
  ActivateInteriorEntitySet(interiorID, "set_lighting_wall_tint01")
  SetInteriorEntitySetColor(interiorID, "set_tint_shell", 1)
  SetInteriorEntitySetColor(interiorID, "set_bedroom_tint", 1)
  SetInteriorEntitySetColor(interiorID, "set_crane_tint", 1)
  SetInteriorEntitySetColor(interiorID, "set_modarea", 1)
  SetInteriorEntitySetColor(interiorID, "set_lighting_tint_props", 1)
  SetInteriorEntitySetColor(interiorID, "set_floor_decal_1", 1)
end
...
function DespawnFacility()
  interiorID = GetInteriorAtCoordsWithType(345.0041, 4842.001, -59.9997, "xm_x17dlc_int_02")
  DeactivateInteriorEntitySet(interiorID, "set_int_02_decal_01")
  DeactivateInteriorEntitySet(interiorID, "set_int_02_lounge1")
  DeactivateInteriorEntitySet(interiorID, "set_int_02_cannon")
  DeactivateInteriorEntitySet(interiorID, "set_int_02_clutter1")
  DeactivateInteriorEntitySet(interiorID, "set_int_02_crewemblem")
  DeactivateInteriorEntitySet(interiorID, "set_int_02_shell")
  DeactivateInteriorEntitySet(interiorID, "set_int_02_security")
  DeactivateInteriorEntitySet(interiorID, "set_int_02_sleep")
  DeactivateInteriorEntitySet(interiorID, "set_int_02_trophy1")
  DeactivateInteriorEntitySet(interiorID, "set_int_02_paramedic_complete")
  DeactivateInteriorEntitySet(interiorID, "Set_Int_02_outfit_paramedic")
  DeactivateInteriorEntitySet(interiorID, "Set_Int_02_outfit_serverfarm")
end
local i = {
  {
  ...
  {
      position = vector3(710.87930000, -813.11000000, 15.19892000),
      type = "int_plan",
      request = {
          "set_plan_casino",
          "set_plan_computer",
      ...
      remove = {"set_plan_wall", "set_plan_pre_setup", "set_plan_no_bed"}
  }
}
Citizen.CreateThread(function()
  for a, j in pairs(i) do
      local k = GetInteriorAtCoordsWithType(j.position.x, j.position.y, j.position.z, j.type)
      if IsValidInterior(k) then
          if j.request then
              for a, l in pairs(j.request) do
                  ActivateInteriorEntitySet(k, l)
              end
          end
          if j.remove then
              for a, l in pairs(j.remove) do
                  DeactivateInteriorEntitySet(k, l)
              end
          end
          RefreshInterior(k)
      end
