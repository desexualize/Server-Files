-- this file define global tools required by AQUA and AQUA extensions
...
function module(rsc, path)
  if path == nil then -- shortcut for AQUA, can omit the resource parameter
    path = rsc
    rsc = "AQUA"
  end
...
local Debug = module("AQUA", "lib/Debug")
