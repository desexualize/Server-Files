...
Citizen.CreateThread(function()
    TriggerServerEvent("AQUARP:PoliceCheckRadial")
    TriggerServerEvent("AQUARP:NHSCheckRadial")
end)
...
function Crosshair(enable)
    TriggerEvent("AQUARP:PutCrossHairOnScreen", enable)
    Display = enable;
end
...
RegisterNetEvent("AQUARP:CleanCar")
AddEventHandler("AQUARP:CleanCar",function()
