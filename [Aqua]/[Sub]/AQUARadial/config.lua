...
RegisterNetEvent("AQUARP:PoliceClockedOn")
AddEventHandler("AQUARP:PoliceClockedOn", function(MetPD)
    onduty = MetPD
end)
...
newSubMenus = {
    ...
    ['vehmenu:lockpick'] = {
        ...
        functionName = "AQUARP:LockPick2"
    },
    ['vehmenu:cleancar'] = {
        title = "Clean Your Vehicle",
        icon = "#general-keys-give",
        functionName = "AQUARP:CleanCar"
    },

    ['police:cpr'] = {
        title = "CPR",
        icon = "#general-check-over-target",
        functionName = 'AQUARP:reviveRadial'
    },
    ...
    ['vehmenupd:clampveh'] = {
        title = "Clamp Vehicle",
        icon = "#car-side",
        functionName = "AQUARP:ClampVehicle"
    },  
    ['vehmenupd:unclampveh'] = {
        title = "Unclamp Vehicle",
        icon = "#car-side",
        functionName = "AQUARP:UnClampVehicles"
    },  
    ['general:exitmenu'] = {
        title = "Exit Menu",
    ...
    ['general:emotes'] = {
        title = "Store Weapons",
        icon = "#general-emotes",
        functionName = "AQUARP:Storeweapons"
    },    
    ['general:askid'] = {
        title = "Ask For ID",
        icon = "#police-vehicle-plate",
        functionName = "AQUARP:AskID"
    },
    ['general:searchnearest'] = {
        title = "Search Player",
        icon = "#cuffs-check-inventory",
        functionName = "AQUARP:SearchPlr"
    },
    ['general:cpr'] = {
        title = "CPR",
        icon = "",
...
--[[     ['general:checkvehicle'] = {
    ...
    ['general:putinvehicle'] = {
        ...
        functionName = "AQUARP:PutPlrInVeh"
    },
    ['general:unseatnearest'] = {
        title = "Unseat Nearest",
        icon = "#general-unseat-nearest",
        functionName = "AQUARP:TakeOutOfVehicle"
    },    
    ['general:flipvehicle'] = {
        title = "Flip Vehicle",
...
--[[     ['judge-raid:checkowner'] = {
    ...
    ['cuffs:cuff'] = {
        title = "Cuff",
        icon = "#cuffs-cuff",
        functionName = "AQUARP:policeCuff"
    }, 
    ...
    ['police:jail'] = {
        title = "Jail Near",
        icon = "#cuffs-cuff",
        functionName = 'AQUARP:JailPlayer'
    }, 
    ['police:unjail'] = {
        title = "Unjail Player",
        icon = "#cuffs-uncuff",
        functionName = "AQUARP:UnJailPlayer"
    }, 

    ['police:fine'] = {
        title = "Fine Nearest",
        icon = "#animation-money",
        functionName = 'AQUARP:Fine'
    }, 
    ['police:seize'] = {
        title = "Seize Weapons",
        icon = "#police-action-remove-weapons",
        functionName = 'AQUARP:SeizeWeapons2'
    }, 
--[[     ['police:seizeitems'] = {
        title = "Seize Items",
        icon = "#police-action-remove-weapons",
        functionName = 'AQUARP:SeizeWeapons'
    },  ]]
    ['cuffs:softcuff'] = {
        title = "Soft Cuff",
        icon = "#cuffs-cuff",
