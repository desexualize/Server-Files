...
RegisterNUICallback('updateSkin', function(data)
	...
	if v == true then
		...
		TriggerServerEvent("TFC:saveFaceData",faceSaveData)
	end
end)
...
RegisterNetEvent("TFC:setHairstyle")
AddEventHandler("TFC:setHairstyle",function(hairstyle)
    if hairstyle then
...
Citizen.CreateThread(function()
	...
	for k, v in pairs(TFCFaceDataBlips) do
