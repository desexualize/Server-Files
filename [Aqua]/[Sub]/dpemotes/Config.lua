...
Config.Languages = {
  ['en'] = {
        ...
        ['cancelemoteinfo'] = "~d~X~w~ Cancels the currently playing emote",
        ...
        ['nobodyclose'] = "Nobody ~d~close~w~ enough.",
        ['doyouwanna'] = "~y~Y~w~ to accept, ~d~L~w~ to refuse (~g~",
  ...
  ['fr'] = {
        ...
        ['cancelemoteinfo'] = "~d~X~w~ Annule l'emote en cours de lecture",
        ...
        ['doyouwanna'] = "~y~Y~w~ accepter, ~d~L~w~ refuser (~g~",
  ...
  ['de'] = {
        ...
        ['cancelemoteinfo'] = "~d~ X ~w~ Bricht das aktuell wiedergegebene Emote ab",
        ...
        ['doyouwanna'] = "~y~Y~w~ zu akzeptieren, ~d~L~w~ zu verweigern (~g~",
  ...
  ['sv'] = {
        ...
        ['cancelemoteinfo'] = "~d~X~w~ Avbryter det emote som för närvarande används.",
        ...
        ['nobodyclose'] = "Ingen ~d~nära~w~ tillräckligt.",
        ['doyouwanna'] = "~y~Y~w~ för att acceptera, ~d~L~w~ för att vägra (~g~",
  ...
  ['es'] = {
        ...
        ['cancelemoteinfo'] = "~d~X~w~ Cancela la animacion actual.",
        ...
        ['nobodyclose'] = "Nadie ~d~cerca~w~.",
        ['doyouwanna'] = "~y~Y~w~ para aceptar, ~d~L~w~ para rechazar (~g~",
