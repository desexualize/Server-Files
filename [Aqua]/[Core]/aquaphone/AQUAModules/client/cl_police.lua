...
RMenu.Add('pdsmall', 'main', RageUI.CreateMenu("", "~d~ Police Armoury", 1300, 50, "banners", "pd"))
RMenu.Add("pdsmall", "sub", RageUI.CreateSubMenu(RMenu:Get("pdsmall", "main"), "", "~d~ Police Armoury", 1300, 50, "banners", "pd"))
RMenu.Add("pdsmall", "whitelistedguns", RageUI.CreateSubMenu(RMenu:Get("pdsmall", "main"), "", "~d~ Police Armoury", 1300, 50, "banners", "pd"))
