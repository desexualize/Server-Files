AQUAcfgdrugsClientT = {}
Tunnel.bindInterface("AQUA_cfgdrugs",AQUAcfgdrugsClientT)
Proxy.addInterface("AQUA_cfgdrugs",AQUAcfgdrugsClientT)
AQUAcfgdrugsServer = Tunnel.getInterface("AQUA_cfgdrugs","AQUA_cfgdrugs")
