function GRPDrugsServer.HeroinGather()
...
function GRPDrugsServer.CanProcessHeroin()
    local user_id = vRP.getUserId({source})
...
function GRPDrugsServer.ProcessHeroin()
    local user_id = vRP.getUserId({source})
...
function GRPDrugsServer.SellHeroin(amount)
    local user_id = vRP.getUserId({source})
