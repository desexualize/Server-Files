        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              GRPDrugsServer.DiamondCanProcess({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  GRPDrugsServer.DiamondDoneProcessing()
...
function sellingDiamondUnits()
     GRPDrugsServer.SellDiamondJob({tonumber(1)})
    return false
end
