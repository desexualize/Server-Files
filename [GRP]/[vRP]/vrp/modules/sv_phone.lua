...
RegisterServerEvent("Galaxy:AskID")
AddEventHandler("Galaxy:AskID",function()
  local player = source
...
RegisterServerEvent("Galaxy:GiveMoney")
AddEventHandler("Galaxy:GiveMoney",function(amount)
  local player = source
...
RegisterNetEvent('Galaxy:TrunkOpened')
AddEventHandler('Galaxy:TrunkOpened', function()
...
RegisterNetEvent('Galaxy:SearchPlr')
AddEventHandler("Galaxy:SearchPlr", function()
  player = source
