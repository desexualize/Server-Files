RMenu.Add('gangmenu', 'main', RageUI.CreateMenu("", "Galaxy Gang Menu", 1300, 100, "gang", "gang"))
...
RMenu.Add("gangmenu", "logs", RageUI.CreateSubMenu(RMenu:Get("gangmenu", "main", 1300, 100)))
...
RageUI.CreateWhile(1.0, RMenu:Get('gangmenu', 'main'), nil, function()
    RageUI.IsVisible(RMenu:Get('gangmenu', 'main'), true, false, true, function()
        ...
        RageUI.ButtonWithStyle("Gang Logs", "", { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
            if Selected then
            end
