...
--end)
--
--RegisterNetEvent('GRP:policeHotkeysTrue')
--AddEventHandler('GRP:policeHotkeysTrue', function() 
--    handcuffed = true
--end)
--
--RegisterNetEvent('GRP:policeHotkeysFalse')
--AddEventHandler('GRP:policeHotkeysFalse', function() 
--    handcuffed = false
--end)
--
--local l = 1
...
--            TriggerServerEvent('GRP:policeDrag')
--            
--            Wait(1000)
--            
--        end
...
--            TriggerServerEvent('GRP:policeCuff')
--            Wait(1000)
--        end
--    end
--end)
--
--RegisterNetEvent("GRP:cuffAnimPolice")
--AddEventHandler("GRP:cuffAnimPolice", function(nplayer, player)
--    local player = player
--    local nplayer = nplayer
--    TriggerServerEvent("GRP:PlayWithinDistance", 0.2 , "cuffing", 1, GetEntityCoords(GetPlayerPed(-1))) 
...
--
--end)
--RegisterNetEvent("GRP:cuffAnimPerp")
--AddEventHandler("GRP:cuffAnimPerp", function()
--
--    TriggerServerEvent("GRP:PlayWithinDistance", 0.2 , "cuffing", 1, GetEntityCoords(GetPlayerPed(-1))) 
...
--end)
--
--RegisterNetEvent("GRP:drag2")
--AddEventHandler('GRP:drag2', function(pl)
--    other = pl
--    drag = not drag
--end)
--
--RegisterNetEvent("GRP:undrag")
--AddEventHandler('GRP:undrag', function(pl)
--    drag = false
--end)
--
--Citizen.CreateThread(function()
