...
RageUI.CreateWhile(1.0, RMenu:Get('MPayMenu', 'main'), nil, function()
    RageUI.IsVisible(RMenu:Get('MPayMenu', 'main'), true, false, true,function()
        ...
        RageUI.Button("Transaction Amount - ~y~[ £" .. finalMPayAmount .. " ]", nil, { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
            if Selected then
        ...
        RageUI.Button("Receivers perm ID - ~y~[ " .. finalPlayerID .. " ]", nil, { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
            if Selected then
    ...
    RageUI.IsVisible(RMenu:Get('MPayMenu', 'confirmation'), true, false, true, function()
        ...
        RageUI.Button("~g~Yes, I confirm this Transaction!", nil, { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
            if Selected then
                ...
                TriggerServerEvent("GRP:SendPayment", finalPlayerID, finalMPayAmount)
