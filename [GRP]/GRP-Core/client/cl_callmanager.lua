...
RMenu.Add('callmanager', 'main', RageUI.CreateMenu("", '~w~Galaxy Call Manager', 1300, 50, "callmanager", "callmanager"))
                        ...
                        if v[2] == GetPlayerServerId(PlayerId()) then
                            ...
                            if not isInTicket then
                                    ...
                                    CallManagerServer.GetUpdatedCoords({v[2]}, function(targetCoords)
                                       ...
                                       -- notify("~g~You recieved £3000 for taking a staff ticket you fat neek ❤️")
                                       notify("~g~You have taken a staff ticket! ❤️")
                                        TriggerServerEvent("GRP:returnMe", v[1], v[2], v[3])
