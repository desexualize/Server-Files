...
TriggerServerEvent("Galaxy:PANIC", GetEntityCoords(GetPlayerPed(-1)))
panic_cooldown = true
end)


RegisterNetEvent("Galaxy:PANICBUTTON")
AddEventHandler("Galaxy:PANICBUTTON", function(coords,paniccolor)
    print(coords)
    ...
    TriggerServerEvent("Galaxy:PlayWithinDistance", 3.0,"panic", 1, GetEntityCoords(GetPlayerPed(-1))) 
    for i = 1,60 do 
    Wait(500)
