...
AddEventHandler('es_bank:toofarlocal', function(robb)
	robbing = false
	TriggerEvent('chatMessage', '[Store Robbery]:', {255, 0, 0}, "The robbery was cancelled, you will receive nothing.", "ooc")
	robbingName = ""
	secondsRemaining = 0
	incircle = false
end)
...
AddEventHandler('es_bank:playerdiedlocal', function(robb)
	robbing = false
	TriggerEvent('chatMessage', '[Store Robbery]:', {255, 0, 0}, "The robbery was cancelled, you died!.", "ooc")
	robbingName = ""
	secondsRemaining = 0
	incircle = false
end)
...
AddEventHandler('es_bank:robberycomplete', function(reward)
	robbing = false
	TriggerEvent('chatMessage', '[Store Robbery]:', {255, 0, 0}, "Robbery done, you received:^2" .. reward, "ooc")
	bank = ""
	secondsRemaining = 0
	incircle = false
end)
