RMenu.Add('LiveryMenu', 'main', RageUI.CreateMenu("", "~w~Galaxy Livery Menu", 1300, 50, "livery", "livery"))

RMenu.Add('LiveryMenu', 'submain', RageUI.CreateSubMenu(RMenu:Get('LiveryMenu', 'main'), "", "~w~Galaxy Livery Menu", 1300, 50, "livery", "livery"))
