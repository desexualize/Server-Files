...
--RegisterNetEvent("GRP:PoliceClockedOn")
--AddEventHandler("GRP:PoliceClockedOn", function(MetPD)
--    onduty = MetPD
--end)
...
newSubMenus = {
    ...
    --     functionName = "GRP:ComingSoon"
    -- }, 
    ['vehmenu:lockpick'] = {
        title = "Lockpick Vehicle",
        icon = "#general-keys-give",
        functionName = "GRP:LockPick2"
    },
    ['general:exitmenu'] = {
        title = "Exit Menu",
    ...
    ['police:cpr'] = {
        ...
        functionName = 'GRPClient:ReviveCPR'
    },
    ...
    ['vehmenupd:clampveh'] = {
        title = "Clamp Vehicle",
        icon = "#car-side",
        functionName = "GRP:ClampVehicle"
    },  
    ['vehmenupd:unclampveh'] = {
        title = "Unclamp Vehicle",
        icon = "#car-side",
        functionName = "GRP:UnClampVehicles"
    },  
    ['general:exitmenu'] = {
        title = "Exit Menu",
        icon = "#animation-hurry",
    ...
    ['general:emotes'] = {
        title = "Store Weapons",
        icon = "#general-emotes",
        functionName = "GRP:Storeweapons"
    },    
    ['general:askid'] = {
        title = "Ask For ID",
        icon = "#police-vehicle-plate",
        functionName = "GRP:AskID"
    },
    ['general:searchnearest'] = {
        title = "Search Player",
        icon = "#cuffs-check-inventory",
        functionName = "GRP:SearchNearest"
    },
...
--[[     ['judge-raid:checkowner'] = {
    ...
    ['police:jail'] = {
        title = "Jail Near",
        icon = "#cuffs-cuff",
        functionName = 'GRP:Jail'
    }, 
    ['police:unjail'] = {
        title = "Unjail Player",
        icon = "#cuffs-uncuff",
        functionName = "GRP:Unjail"
    }, 

    ['police:fine'] = {
        title = "Fine Nearest",
        icon = "#animation-money",
        functionName = 'GRP:Fine'
    }, 
    ['police:seize'] = {
        title = "Seize Weapons",
        icon = "#police-action-remove-weapons",
        functionName = 'GRP:SeizeWeapons'
    }, 
    ['police:seizeitems'] = {
        title = "Seize Items",
        icon = "#police-action-remove-weapons",
        functionName = 'GRP:SeizeItems'
    }, 
    ['cuffs:softcuff'] = {
        title = "Soft Cuff",
        icon = "#cuffs-cuff",
...
--[[     ['cuffs:remmask'] = {
    ...
    ['police:escort'] = {
        title = "Drag Player",
        icon = "#general-escort",
        functionName = 'GRP:policeDrag'
    },
    ['police:putinvehicle'] = {
        title = "Put In Vehicle",
        icon = "#general-put-in-veh",
        functionName = "GRP:putinveh"
    },
    ['police:unseatnearest'] = {
        title = "Unseat Player",
        icon = "#general-unseat-nearest",
        functionName = "GRP:takeoutveh"
    },
    ['police:cuff'] = {
        title = "Cuff",
        icon = "#cuffs-cuff",
